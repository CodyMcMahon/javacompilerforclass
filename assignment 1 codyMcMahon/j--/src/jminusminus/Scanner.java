...
class Scanner {
    ...
    public TokenInfo getNextToken() {
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                //multiline comments
                  ...
                  nextCh();
                  if(ch == EOFCH){
                    reportScannerError("unexpected EOF in comment");
                  } 
                //end thing I added
                } else {
        ...
        case ':':
            nextCh();
            return new TokenInfo(CONDITIONAL_SECOND, line);
        case '?':
            nextCh();
            return new TokenInfo(CONDIDITIONAL_START, line);
        case ',':
            nextCh();
        ...
        case '&':
            ...
            if (ch == '=') {
                nextCh();
                return new TokenInfo(BIT_AND_ASSIGN, line);
            } else if (ch == '&') {
                nextCh();
        ...
        case '>':
            ...
            if (ch == '='){
                ...
                if(ch == '>'){
                  nextCh();
                  return new TokenInfo(ZRSHIFT, line);
                }
                else if(ch == '='){
                  nextCh();
        ...
        case '%':
          nextCh();
            if (ch == '=') {
                nextCh();
                return new TokenInfo(MODULUS_ASSIGN, line);
            } else {
                return new TokenInfo(MODULUS, line);
            }
        case '~':
          nextCh();
          return new TokenInfo(BIT_COMP, line);
        ...
        case '0':
            ...
            nextCh();
             /* if (ch == 'd'|| ch == 'D'){
                ...
                return new TokenInfo(DEC_LITERAL, buffer.toString(), line);
              }*/
              if (ch == 'x'||ch == 'X'){
                nextCh();
                while (ch == '0' || ch == '1' ||
                ...
                return new TokenInfo(BIN_LITERAL, buffer.toString(), line);
              } 
                          //returns octals "0 will be an octal number"
            else{
              while (ch == '0' || ch == '1' || 
                     ch == '2' || ch == '3' || 
                     ch == '4' || ch == '5' || 
              ...
              return new TokenInfo(OCT_LITERAL, buffer.toString(), line);
            }
              //error is the digit after 0x is not recongnized
              /*else{
                reportScannerError("Malformed int identifier (0x?)");
              }*/
