...
/** The body. */
    ...
    /** The body. */
    private JStatement body2;
	
    /** The body. */
    private JStatement body3;
    ...
    public JTryStatement(int line, JExpression condition, JStatement body, JStatement body2, JStatement body3) {
        super(line);
        this.body = body;
